...
fun Light(
    ...
    intensityValueUpdated: (Int) -> Unit
) {

    var intensityValue by remember {
        mutableStateOf(device.lightIntensity)
    }
    ...
    Card(
        ...
        Column(
            ...
            ColorfulSlider(
                value = intensityValue?.toFloat() ?: 0f,
                valueRange = 0f..4f,
                onValueChange = { value, _ ->
                    intensityValue = value.roundToInt()
                },
                trackHeight = 7.dp,
                ...
                onValueChangeFinished = {
                    intensityValueUpdated.invoke(intensityValue ?: 0)
                }
            )
            ...
            Row(
                ...
                Text(
                    text = "Intensity: ${(intensityValue ?: 0) * 25}%",
                    style = MaterialTheme.typography.bodyLarge,
                    color = MaterialTheme.colorScheme.onBackground,
                    maxLines = 1,
                    overflow = TextOverflow.Ellipsis
